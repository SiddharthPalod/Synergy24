import{j as e,_ as t,b as P,r as u,L as T}from"./index-3a1779f7.js";import{d as N,I as s}from"./event_image-b2088c41.js";import{m as p}from"./motion-9ad2ce3e.js";const r=({name:n,desc:o,mode:c})=>{const d=c==="1"?"border-red1":c==="2"?"border-blue1":"border-gray-500";return e.jsxs("div",{className:"flex flex-col h-screen justify-center items-center gap-10 text-left",children:[e.jsx("div",{className:"text-4xl md:text-6xl font-bold text-white",children:n}),e.jsx("div",{className:`overflow-scroll border-2 ${d} p-4 mx-16 md:mx-32 lg:mx-64 text-sm text-left  md:text-lg`,children:o})]})},l=({openNavigation:n,children:o})=>e.jsx("div",{children:n&&e.jsx("div",{className:"absolute w-screen h-screen md:-top-[27vh] md:-left-1/3 left-0 top-0 backdrop-filter backdrop-blur-lg bg-opacity-10 bg-neutral-900 flexCenter flex-col text-center",children:o})}),_=[{route:"/event_day1/1",name:"Pitching Pixels 2.0",about:"Put your entrepreneurial skills to the test and compete with top rising talents in the business world. Pitch your game-changing ideas.",rules:"Discuss the significance of the problem and proposed solution, the needs addressed, and the target market. Highlight the unique features that differentiate your solution from existing options. Lastly, outline the business model, including revenue generation, pricing strategy, and distribution channels.",impInfo:`• Mode: Online
• Team Size: 1-3
• Prize Pool: 20k
...
• Rounds: 1 round
`,contact:"Assign Volunteer",link:"Create form",imageName:"mernify"},{route:"/event_day1/5",name:"Deep Reality",about:"Can you identify whether a image,video,audio is real or generated by AI? If yes, then this event is for you",rules:`1. Eligibility
...
- All participants must have active Codeforces accounts.`,impInfo:`• Mode: Individual
• Team Size: no theme
• Theme: 15k
• Prize Pool: not decided
• Prize Distribution: 9 Nov 7pm onwards
• Timeline: 9 Nov
• Registration Timeline: Knock-out tournament
• Rounds: - Participation is limited to IIIT-B students no external participants are allowed
-Participants are randomly paired to compete in one-on-one duels. 
- The winner of each duel advances, while the loser is eliminated.
- The tournament continues until only one participant remains, who is declared the champion. The final opponent takes the second prize.
- For each duel, a toss determines who picks either the problem category or the difficulty rating. The other participant selects the remaining option.
...
• Registration Timeline: 10 Nov
• Rounds: 1 Round
`,contact:"Varshith (9886987649), Nathan (8848839946)",link:"Create form",imageName:"lensFlare"},{route:"/event_day3/3",name:"ML-Fiesta",about:"ML-Fiesta is our AI/ML hackathon where the brightest engineering minds can come together to solve real-life problems that have a meaningful impact.",rules:"Please refer to the detailed problem statement to understand the rules. The judges retain the right to withhold prizes if submissions do not meet the expected standards",impInfo:`• Mode: Online
• Team Size: 1-3
• Prize Pool: 60k
...
• Rounds: 1 Round
`,contact:"Siddharth Palod 7878099721",link:"https://unstop.com/hackathons/pixel-flow-20-synergy24-international-institute-of-information-technology-iiit-bangalore-1179218",imageName:"pixelFlow"},{route:"/event_day3/6",name:"Sands of Time",about:"Will reveal soon",rules:"Will reveal soon",impInfo:"Will reveal soon",contact:"Will reveal soon",link:"",imageName:""}],I=_.map(n=>({...n,image:null})),R=async n=>{switch(n){case"bgmi":return t(()=>import("./bgmi-f1bf1912.js"),[]);case"bidbuild":return t(()=>import("./bidBuild-90fa193f.js"),[]);case"cipherChase":return t(()=>import("./cipherChase-ad2a3368.js"),[]);case"codeQuest2":return t(()=>import("./codeQuest2-b3bbd6ca.js"),[]);case"codm":return t(()=>import("./codm-f2356771.js"),[]);case"cr":return t(()=>import("./cr-0d165b67.js"),[]);case"dapp":return t(()=>import("./dapp-46e42f8a.js"),[]);case"deepReality":return t(()=>import("./deepReality-2545da33.js"),[]);case"eafc":return t(()=>import("./eafc-e4b605cf.js"),[]);case"lensFlare":return t(()=>import("./lensFlare-5b941725.js"),[]);case"lockoutDuel":return t(()=>import("./lockoutDuel-7bc1975e.js"),[]);case"mernify":return t(()=>import("./mernify-728ebc4b.js"),[]);case"mlFiesta":return t(()=>import("./mlFiesta-582c61fc.js"),[]);case"pitchingPixels":return t(()=>import("./pitchingPixels-da1d5596.js"),[]);case"pixelFlow":return t(()=>import("./pixelFlow-72d4b344.js"),[]);case"reelRiot":return t(()=>import("./reeLRiot-25177b92.js"),[]);case"synMun":return t(()=>import("./synMun-2631d7c3.js"),[]);case"triviaVerse":return t(()=>import("./triviaVerse-349ebd50.js"),[]);case"valo":return t(()=>import("./valo-2972f338.js"),[]);case"triviaVerse":return t(()=>import("./triviaVerse-349ebd50.js"),[]);default:throw new Error(`Unknown SVG: ${n}`)}},C=()=>{const n=P(),[o,c]=u.useState(!1),[d,b]=u.useState(!1),[m,v]=u.useState(!1),[h,y]=u.useState(!1),[i,k]=u.useState(null),a=(f,g)=>{g(!f)};return u.useEffect(()=>{const f=n.event_day.slice(-1),g=n.event,w=I[N[f-1]+(g-1)];(async()=>{const x=await R(w.imageName);k({...w,image:x.default})})()},[n.event_day,n.event]),i?e.jsxs("section",{className:"flexCenter",children:[e.jsx(T,{className:"fixed text-white button-back-events z-50 top-0 left-0 text-xl md:text-4xl p-4 font-bold",to:"/events",children:"< BACK"}),e.jsxs(p.div,{className:"h-screen mb-4 flexBetween flex-col justify-evenly md:gap-2 pt-2 sm:pt-20 text-white",initial:{opacity:0},animate:{opacity:1},transition:{duration:1.5},children:[e.jsxs("div",{className:"hidden md:flexBetween absolute top-[27vh] w-3/5 h-2/5 mx-auto font-semibold heading3",children:[e.jsxs("div",{className:"flexBetween flex-col h-full",children:[e.jsxs("button",{onClick:()=>a(o,c),className:"flexCenter flex-col gap-3",children:["About",e.jsx(s,{icon:"iconamoon:profile-fill",width:"3.5rem",height:"3.5rem",className:"border-2 border-red1 rounded-lg p-1"}),e.jsx(l,{openNavigation:o,children:e.jsx(r,{name:"About Event",desc:i.about,mode:"1"})})]}),e.jsxs("button",{onClick:()=>a(d,b),className:"flexCenter flex-col gap-3",children:["Rules",e.jsx(s,{icon:"carbon:rule-filled",width:"3.5rem",height:"3.5rem",className:"border-2 border-red1 rounded-lg p-1"}),e.jsx(l,{openNavigation:d,children:e.jsx(r,{name:"Rules",desc:i.rules,mode:"1"})})]})]}),e.jsxs("div",{className:"flexBetween flex-col h-full",children:[e.jsxs("button",{onClick:()=>a(m,v),className:"flexCenter flex-col gap-3",children:["Imp Info",e.jsx(s,{icon:"fa-solid:exclamation",width:"3.5rem",height:"3.5rem",className:"border-2 border-blue1 rounded-lg p-1"}),e.jsx(l,{openNavigation:m,children:e.jsx(r,{name:"Important Info",desc:i.impInfo,mode:"2"})})]}),e.jsxs("button",{onClick:()=>a(h,y),className:"flexCenter flex-col gap-3",children:["Contact",e.jsx(s,{icon:"ph:phone-fill",width:"3.5rem",height:"3.5rem",className:"border-2 border-blue1 rounded-lg p-1"}),e.jsx(l,{openNavigation:h,children:e.jsx(r,{name:"Contact",desc:i.contact,mode:"2"})})]})]})]}),e.jsx(p.img,{src:i.image,alt:i.name,className:"md:w-full md:h-3/5 h-1/2 flex px-6 sm:w-3/5 object-contain",initial:{scale:.8,opacity:0},animate:{scale:1,opacity:1},transition:{duration:1.5,ease:"easeInOut"}}),e.jsx(p.div,{className:"heading1 text-4xl lg:text-6xl text-white tracking-[.07em]",initial:{y:-10,opacity:0},animate:{y:0,opacity:1},transition:{duration:1,ease:"easeOut"},children:i.name}),e.jsx(p.button,{className:"md:px-16 px-12 py-1.5 border-[3.5px] heading3 text-white font-semibold rounded-[1.25rem] border-blue1 tracking-[.07em]",whileHover:{scale:1.05},whileTap:{scale:.95},onClick:()=>window.open(i.link,"_blank"),children:"Register"}),e.jsxs("div",{className:"md:hidden gap-7 w-screen grid grid-cols-4 px-8 justify-evenly items-center ",children:[e.jsxs("button",{onClick:()=>a(o,c),className:"flex flex-col justify-end items-center h-full",children:[e.jsx("div",{className:"text-center leading-none pb-1",children:"About Event"}),e.jsx(s,{icon:"iconamoon:profile-fill",className:"border-2 border-red1 rounded-lg p-1 md:w-14 md:h-14 w-10 h-10"}),e.jsx(l,{openNavigation:o,children:e.jsx(r,{name:"About Event",desc:i.about,mode:"1"})})]}),e.jsxs("button",{onClick:()=>a(d,b),className:"flex justify-end items-center flex-col h-full",children:[e.jsx("div",{className:"text-center leading-none pb-1",children:"Rules"}),e.jsx(s,{icon:"carbon:rule-filled",className:"border-2 border-red1 rounded-lg p-1 md:w-14 md:h-14 w-10 h-10"}),e.jsx(l,{openNavigation:d,children:e.jsx(r,{name:"Rules",desc:i.rules,mode:"1"})})]}),e.jsxs("button",{onClick:()=>a(m,v),className:"flex justify-end items-center flex-col h-full ",children:[e.jsx("div",{className:"text-center leading-none pb-1",children:"Imp Info"}),e.jsx(s,{icon:"fa-solid:exclamation",className:"border-2 border-blue1 rounded-lg p-1 md:w-14 md:h-14 w-10 h-10"}),e.jsx(l,{openNavigation:m,children:e.jsx(r,{name:"Important Info",desc:i.impInfo,mode:"2"})})]}),e.jsxs("button",{onClick:()=>a(h,y),className:"flex justify-end items-center flex-col h-full",children:[e.jsx("div",{className:"text-center leading-none pb-1",children:"Contact"}),e.jsx(s,{icon:"ph:phone-fill",className:"border-2 border-blue1 rounded-lg p-1 md:w-14 md:h-14 w-10 h-10"}),e.jsx(l,{openNavigation:h,children:e.jsx(r,{name:"Contact",desc:i.contact,mode:"2"})})]})]})]})]}):e.jsx("div",{children:"Loading..."})};export{C as default};
