...
function Navbar() {
        ...
        return (
        <nav className="pt-4 flex font-bold items-center justify-between px-4 fixed top-0 w-full z-50 bg-transparent">
                
                <Link to={'/'} className="w-60 max-sm:w-1/2 scroll-smooth" onClick={scrollToTop}>
