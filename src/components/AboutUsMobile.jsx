    ...
    <section className="flex justify-center items-center h-full md:h-screen">
      <div className="py-16 px-4">
        <div className="md:gap-10 flex flex-col md:flex-row font-bold px-1 md:px-4 text-center">
          ...
          >
            <div className="card h-[25rem] md:scale-100 scale-75 md:w-96 glass">
              <div className="card-body">
                <h2 className="card-title">About Synergy</h2>
                <p className='text-left font-light'>
                  Synergy'24 is the annual techfest of IIIT-Bangalore, bringing together innovation and collaboration in an exciting event. <br />
                  It includes hackathons, coding competitions, and entrepreneurial challenges, giving students a chance to show off their skills and creativity. <br />
                  Attendees can learn from top industry leaders through talks and workshops, gaining useful insights and inspiration. <br />
                  The event also celebrates the diverse culture of the institute, bringing together students, professors, researchers, and engineers in a fun and creative technical festival. <br />
          ...
          >
            <div className="card h-[25rem] md:scale-100 scale-75 md:w-96 glass">
              <div className="card-body">
                ...
                <p className='text-left font-light'>
                  The International Institute of Information Technology Bangalore, also referred to as IIIT-B, is a deemed university that was founded in 1998 with the goal of advancing innovation, entrepreneurship, and education and research in the field of information technology. <br />
                  The Karnataka government and the IT sector jointly sponsor the Institute, which is a registered not-for-profit society. <br />
